...
let changeQA = () => {
	...
	ans1.innerHTML = `${computerQuestions[i].options[0]}`;
	ans2.innerHTML = `${computerQuestions[i].options[1]}`;
	ans3.innerHTML = `${computerQuestions[i].options[2]}`;
	ans4.innerHTML = `${computerQuestions[i].options[3]}`;
...
console.log(computerQuestions.length)
